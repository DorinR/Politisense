...
const FinancialRecord = require('../../../backend/firebase/model/FinancialRecord').FinancialRecord
const Politician = require('../../../backend/firebase/model/Politician').Politician
