...
import {getMinisters} from "../Dashboard/General/GeneralDashboard";
...
function ChangeAccountPassword (props) {
    ...
    async function checkTokenValid(){
        return axios
            .post('/api/users/checkTokenValid',{token:props.match.params.token})
            .then(res => {
                return res.data
            })
            .catch(err => console.log(err))
    ...
    useEffect(() => {
        async function getData () {
            let response = await checkTokenValid()
