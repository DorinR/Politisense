                  ...
                  <Grid container>
                    <Grid container>
                      <Grid item xs={6} className={classes.social}>
                        <FacebookLoginButton onClick={() => validateUserFromSocialProviders('facebook', handleSocialLogin)} />
                      </Grid>
                      <Grid item xs={6} className={classes.social}>
                        <TwitterLoginButton onClick={() => validateUserFromSocialProviders('twitter', handleSocialLogin)} />
                      </Grid>
                    </Grid>
                    <Grid container>
                      <Grid item xs={6} className={classes.social}>
                        <GoogleLoginButton type='button' id='test' onClick={() => validateUserFromSocialProviders('google', handleSocialLogin)} />
                      </Grid>
                      <Grid item xs={6} className={classes.social}>
                        <MicrosoftLoginButton onClick={() => validateUserFromSocialProviders('microsoft', handleSocialLogin)} />
                      </Grid>
                    </Grid>
                  </Grid>
                </div>
