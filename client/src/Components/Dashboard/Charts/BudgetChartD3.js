...
export default class BudgetChartD3 {
    ...
    constructor (element,data) {
        ...
        let chartWidth = 800,
            barHeight = 30,
            groupHeight = barHeight * budgetData.series.length,
            gapBetweenGroups = 15,
            spaceForLabels = 150,
            spaceForLegend = 200;
        ...
        let chartHeight = barHeight * zippedData.length + gapBetweenGroups * budgetData.labels.length;
        //d3.min(zippedData)
        ...
        bar.append("text")
            ...
            .attr("dy", ".35em")
            .text(function (d, i) {
                if (i % budgetData.series.length === 0)
                    return budgetData.labels[Math.floor(i / budgetData.series.length)];
                else
                    return ""
            });
