        ...
        <div {...rest} className={clsx(classes.root, className)}>
          <Typography className={classes.name} variant='h6'>
            {props.representative.name
              ? capitalizedName(props.representative.name)
              : ''}
          </Typography>
          {props.representative.riding ? (
            props.representative.riding.length > 22 ? (
              <div className={classes.containerLongRidingName}>
                ...
                <Typography
                  className={classes.longRidingName}
                  variant='caption'
                >
                  {capitalizedName(props.representative.riding)}
                </Typography>
              </div>
            ) : (
              <Typography
                ...
                variant='caption'
              >
                {'Represents: ' + capitalizedName(props.representative.riding)}
              </Typography>
            )
          ) : (
            <Typography
          ...
          {props.representative.party ? (
            props.representative.party.length > 15 ? (
              <div className={classes.containerLongRidingName}>
                <Typography
                  className={classes.fontColorTypography}
                  variant='caption'
                ...
                <Typography
                  ...
                  variant='caption'
                >
                  {capitalizedName(props.representative.party)}
                </Typography>
              </div>
            ) : (
              <Typography
